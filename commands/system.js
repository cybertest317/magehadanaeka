...
cmd({
        ...
        async(Void, citel, text, isAdmins) => {
            ...
            const alivtxt = `
╭────────────────ᰔ
│ ░▓█🧚‍♂️ *ʜᴇʟʟᴏ, ${citel.pushName},*
│ ░▓█🧚‍♂️ ᴛʜɪꜱ ɪꜱ ᴘᴀꜱɪɴᴅᴜ
│ ░▓█🧚‍♂️ ${alivemessage}
│ 
│ ░▓█🧚‍♂️ *ᴠᴇʀꜱɪᴏɴ:-* _5.0.0_
│ ░▓█🧚‍♂️ *ᴜᴘᴛɪᴍᴇ:-* _${runtime(process.uptime())}_
│ ░▓█🧚‍♂️ *ᴏᴡɴᴇʀ:-* _${Config.ownername}_
│ ░▓█🧚‍♂️ *Branch:-* _ᴘᴀꜱɪɴᴅᴜ_
│ 
│ ░▓█🧚‍♂️ _ᴛʏᴘᴇ ${prefix}ᴍᴇɴᴜ ꜰᴏʀ ᴍʏ ᴄᴏᴍᴍᴀɴᴅ ʟɪꜱᴛ._
╰────────────────ᰔ
© ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴘᴀꜱɪɴᴅᴜ ꜱᴇʜᴀɴ
`;
            let aliveMessage = {
                image: {
                    url: await botpic(),
